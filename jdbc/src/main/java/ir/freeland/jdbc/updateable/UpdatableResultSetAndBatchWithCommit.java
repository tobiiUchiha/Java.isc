...
public class UpdatableResultSetAndBatchWithCommit {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try (
                ...
                ResultSet resultSet  = statement.executeQuery("SELECT * FROM EMPLOYEES") // Replace with your actual table name
            ) {
        	...
        	while (resultSet.next()) {
                ...
                resultSet.updateRow(); // does not propagate changes to database
